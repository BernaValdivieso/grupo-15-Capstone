...
planes_contrato_1 = {'contrato': 1, 'planes': [i for i in planes_empresa1.keys()]}
planes_contrato_2 = {'contrato': 2, 'planes': [i for i in planes_empresa2.keys()]}
planes_contrato_3 = {'contrato': 3, 'planes': [i for i in planes_empresa3.keys()]}
planes_contrato_4 = {'contrato': 4, 'planes': [i for i in planes_empresa4.keys()]}

puertos = [i for i in range(1,9)]

planes_contratos = [planes_contrato_1, planes_contrato_2, planes_contrato_3, planes_contrato_4]
#planes_contratos = [planes_contrato_2]
planes_contratos1 = [planes_contrato_1]
planes_contratos2 = [planes_contrato_2]
planes_contratos3 = [planes_contrato_3]
planes_contratos4 = [planes_contrato_4]
    ...
    for contrato in planes_contratos:
        for plan in contrato['planes']:
            ...
            for n in plan:
                if not n == 0:
                    conteo_cargas+=1
            combinaciones[str(plan)]=conteo_cargas
    ...
    for contrato in planes_contratos:
        for plan in contrato['planes']:
            for puerto in puertos:
                ...
                combinaciones[str((str(plan),str(puerto)))] = cargas
    return combinaciones
...
for item in planes_empresa1.keys():
    C_1_p[str(item)] = planes_empresa1[item]
    
for item in planes_empresa2.keys():
    C_2_p[str(item)] = planes_empresa2[item]
    
for item in planes_empresa3.keys():
    C_3_p[str(item)] = planes_empresa3[item]
    
for item in planes_empresa4.keys():
    C_4_p[str(item)] = planes_empresa4[item]
...
U1_1_p = generador_de_u1(planes_contratos1)
U1_2_p = generador_de_u1(planes_contratos2)
U1_3_p = generador_de_u1(planes_contratos3)
U1_4_p = generador_de_u1(planes_contratos4)
#print(U1_1_p)
...
U2_1_p_d = generador_de_u2(planes_contratos1,puertos)
U2_2_p_d = generador_de_u2(planes_contratos2,puertos)
U2_3_p_d = generador_de_u2(planes_contratos3,puertos)
U2_4_p_d = generador_de_u2(planes_contratos4,puertos)
print(U2_2_p_d)
...
#CMIN_M_f = {1:300000,2:280000,3:220000,4:190000}
...
for cliente in clientes:
    ...
    MINQU_j_c[cliente] = clientes[cliente].min_qu
    MAXQU_j_c[cliente] = clientes[cliente].max_qu
